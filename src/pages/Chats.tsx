  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="mx-auto max-w-lg px-4 flex flex-col items-center justify-center pt-32 text-center">
        ...
        <h2 className="text-base font-semibold text-foreground">No chats yet</h2>
        <p className="text-sm text-muted-foreground mt-1">Join a plan to start chatting with your group</p>
      </main>
      <BottomNav />
    </div>
  );
